[Overview](#Overview)  | [Usage Examples](#Examples)  | [Provided
...
For more detailed usage instructions for the **module** command, please
...
First, before installing your own software, be sure to check whether [it
